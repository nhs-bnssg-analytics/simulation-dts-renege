...
for(i in 1:max_time){
  ...
  #but the element of the patient_current record which corresponds to this time is element i+1
  #because the patient_current record is initilised at time=0
  #but R indexes from 1, not zero
  
  #4.1 increment waits ####
  #data.table of location (node or queue for node) of patient
  #at current time, for each patient
  #stored in list
